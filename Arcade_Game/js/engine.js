...
var Engine = (function(global) {
    ...
    function checkCollision(entity1, entity2) {
     ...
     function checkWinningConditions() {
        if (player.y < app.top_offset + 1 * app.tile_height) {
            console.log('You Won !!');
            reset();
    ...
    function render() {
        ...
        for (row = 0; row < app.numRows; row++) {
            for (col = 0; col < app.numCols; col++) {
                ...
                ctx.drawImage(Resources.get(rowImages[row]), col * app.tile_width, row * app.tile_height);
            }
        }
